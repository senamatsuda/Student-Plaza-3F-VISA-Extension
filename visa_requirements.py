...
現在の身分・状況・奨学金区分ごとに必要書類を整理し、Flask アプリなどの
...
STATUS_RULES: Dict[str, List[Scenario]] = {
    "正規生": [
        Scenario(
            label="この期間内に、現在と同じ身分で正規生として在籍していた",
            requirements=[
                "成績証明書（証明書自動発行機で発行）",
                "在学証明書（証明書自動発行機で発行）",
            ],
        ...
        Scenario(
            label="この期間内に、現在とは異なる身分で正規生として在籍していた（学部生→修士、修士→博士等）",
            requirements=[
                "成績証明書（証明書自動発行機で発行）",
                "在学証明書（証明書自動発行機で発行）",
                "修了証明書（旧所属の支援室で発行）",
    ...
    "研究生": [
        ...
        Scenario(
            label="この期間内に、3+1特別聴講生(C)として在籍していた（9月で在留期限が切れる場合）",
            requirements=[
                "外国人研究生証明書(別紙様式５)（所属の支援室で発行）",
                "成績証明書（3+1プログラムの成績）",
            ],
    ...
    "特別聴講学生": [
        ...
        Scenario(
            label="この期間内に、本学の特別聴講生として在籍していた",
            requirements=[
                "在学証明書（所属の支援室で発行）",
                "成績証明書（所属の支援室で発行）",
            ],
